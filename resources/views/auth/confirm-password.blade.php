...
@section('content')
    ...
    <form method="POST" action="{{ route('password.confirm') }}">
        ...
        <div>
            ...
            <input id="password" class="block mt-1 w-full border-gray-300 focus:border-slate-500 focus:ring-slate-500 rounded-md shadow-sm" type="password" name="password" required autocomplete="current-password">
            @error('password')
